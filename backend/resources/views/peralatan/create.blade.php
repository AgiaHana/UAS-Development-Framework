                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('peralatan.store') }}" method="post">
                        ...
                        <div class="form-group" style="margin-right: 24px;">
                            ...
                            <input type="text" class="form-control" id="perlangkapan" placeholder="masukkan perlengkapan alat" name="perlangkapan">
                        </div>
                        ...
                        <div class="d-sm-flex align-items-center mb-4">
                            <div class="form-group" style="margin-right: 24px;">
                                ...
                                <input type="text" class="form-control" id="tersedia" placeholder="Alat tersedia" name="tersedia">
                            </div>
                            <div class="form-group" style="margin-left: 24px;">
                                <label for="jumlah">Jumlah</label>
                                <input type="text" class="form-control" id="jumlah" placeholder="Jumlah Alat" name="jumlah">
                            </div>
                        </div>
